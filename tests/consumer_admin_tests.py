...
class ApiAdminClientTest(unittest.TestCase):
    ...
    def test_update_or_create_creates_consumer(self):
        ...
        # Exercise
        self.consumer_admin_client.update_or_create(data)

        # Verify
        self.session_mock.put.assert_called_once_with(self.consumer_endpoint,
                                                      data=data)

    def test_update_or_create_conflict_name(self):
        # Setup
        self.session_mock.put.return_value.status_code = 409
        self.session_mock.put.return_value.content = {"username": "already exists with value '%s'"
        ...
        # Verify
        self.assertRaisesRegex(NameError, 'already exist',
                               lambda: self.consumer_admin_client.update_or_create(data))

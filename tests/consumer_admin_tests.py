...
class ApiAdminClientTest(unittest.TestCase):
    ...
    def test_create_consumer_w_username(self):
        # Exercise
        self.consumer_admin_client.perform_create(username=self.consumer_username)
    ...
    def test_create_consumer_w_custom_id(self):
        # Exercise
        self.consumer_admin_client.perform_create(custom_id=self.consumer_custom_id)
    ...
    def test_create_consumer_wo_parameters(self):
        ...
        self.assertRaisesRegex(ValueError, r'username',
                               self.consumer_admin_client.perform_create)
    ...
    def test_create_conflict_username(self):
        ...
        self.assertRaisesRegex(NameError, r'already exists',
                               lambda: self.consumer_admin_client.perform_create(self.consumer_username))
    ...
    def test_retrieve(self):
        # Exercise
        self.consumer_admin_client.perform_retrieve(self.consumer_username)
    ...
    def test_list_consumers(self):
        ...
        generator = self.consumer_admin_client.perform_list()
    ...
    def test_list_consumers_w_params(self):
        ...
        self.session_mock.get.return_value.json\
            .return_value = {'total': 1, 'data': [self.consumer_data]}
        generator = self.consumer_admin_client.perform_list(id=self.consumer_id,
                                                            username=self.consumer_username,
                                                            custom_id=self.consumer_custom_id)
    ...
    def test_list_consumers_w_invalid_params(self):
        ...
        self.assertRaisesRegex(KeyError, 'invalid_field',
                               lambda: self.consumer_admin_client.perform_list(**invalid_query))
    ...
    def test_update_consumer(self):
        ...
        # Exercise
        self.consumer_admin_client.perform_update(self.consumer_username, **data)
    ...
    def test_update_consumer_w_invalid_params(self):
        ...
        self.assertRaisesRegex(KeyError, 'invalid_field',
                               ...
                               .perform_update(self.consumer_username, **data))

    def test_delete_consumer(self):
        # Exercise
        self.consumer_admin_client.perform_delete(self.consumer_username)
    ...
    def test_delete_w_invalid_value(self):
        ...
        self.assertRaisesRegex(TypeError, 'str',
                               lambda: self.consumer_admin_client.perform_delete(invalid_value))
